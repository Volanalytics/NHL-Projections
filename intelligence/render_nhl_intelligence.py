...
def render(data):
    ...
    return "".join(out)
def main():
    ap=argparse.ArgumentParser();ap.add_argument("--input",default="intelligence/current/nhl_intelligence.json");ap.add_argument("--out",default="intelligence.html");args=ap.parse_args()
